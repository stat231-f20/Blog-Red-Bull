...
A social media presence has turned into one of the important components of professional athletes. Increasingly, it has become a luxury and even a necessity in today's world for athletes to use their platform to inspire the youth or create change in the world. Our group looked at the potential relationship between the number of tweets in a given week and player performance for that week. Specifically, the question we tried to answer was 

- Does a quarterback's twitter habits affect their performance on the pitch ? 

We hypothesized that a player who tweets a lot in the week prior to a game may be cocky and perform worse in that game. 

# Data

We selected quaterbacks using the following criteria and received a final sample size of 20.

- Started in at least 7 games
- Has a public twitter account
- Tweeted at least once since 9/1/20
...
- go to https://stat231-f20.github.io/Blog-Red-Bull/ to see the published test document (this is publicly available!)
...
You can include [Links](https://www.datadreaming.org/post/r-markdown-theme-gallery/) and images ![team logo](https://raw.githubusercontent.com/stat231-f20/Blog-Red-Bull/main/images/sports1-5.png)
